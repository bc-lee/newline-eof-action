...
exports.ensureNewlineEof = exports.readFile = void 0;
...
function ensureNewlineEof(buffer, fileName = null) {
    if (buffer.includes("\r")) {
        throw new Error(`Sorry, your file ${fileName} contains CR character`);
    }
    if (buffer.byteLength > 0 &&
        buffer[buffer.byteLength - 1] !== "\n".charCodeAt(0)) {
        throw new Error(`Sorry, your file ${fileName} does not ends with newline character`);
    }
}
exports.ensureNewlineEof = ensureNewlineEof;
